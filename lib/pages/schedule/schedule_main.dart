          ...
          actions: [
            ...
            TextButton(
              onPressed: () {
                ...
                Navigator.of(context).pop();
                _fetchScheduleData(dayName); // Refresh the list after deleting a subject
              },
            ...
            itemBuilder: (context, index) {
              ...
              return Card(
                  ...
                  child: ListTile(
                    ...
                    onLongPress: () => _deleteClass(context, dateSheet.subName,dateSheet.day),
...
class ScheduleEntryDialog extends StatefulWidget {
  ...
  const ScheduleEntryDialog({Key? key, required this.onAddSchedule})
      : super(key: key);
